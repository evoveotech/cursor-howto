# Roadmap: cursor-howto 2026–2027
...
Transform cursor-howto from a static tutorial repo into a **living, dual-audience knowledge system**:
...
- **For AI agents** — structured metadata index that agents query before performing Cursor tasks, making this repo infrastructure, not just content
...
| P6 | Content Quality | Expand weakest modules; project `CURSOR.md` |
...
- Root `CURSOR.md` — project's own configuration as a best-practice example
...
- `skills/cursor-howto-lookup/SKILL.md` — lightweight agent skill that queries the manifest
...
- Pinned GitHub Discussion: "Share your Cursor workflows" — signal collection for agent usage
...
- `/docs-sync-cursor-code` skill runs after every CC release → `WHATS-NEW.md` updated
...
| `skills/cursor-howto-lookup/SKILL.md` | Skill | P4 |
