...
The security of the Cursor How To project is important to us. This document outlines our security practices and describes how to report security vulnerabilities responsibly.
...
- Vulnerabilities in the Cursor application (report to [Cursor](https://cursor.com) / Anysphere)
...
1. Visit: https://github.com/evoveotech/cursor-howto/security/advisories
...
Past security advisories are available in the [GitHub Security Advisories](https://github.com/evoveotech/cursor-howto/security/advisories) tab.
...
Thank you for helping keep Cursor How To secure! 🔒
