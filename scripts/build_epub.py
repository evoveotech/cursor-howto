...
# ///
"""
Build an EPUB from the Cursor How-To markdown files.
...
Usage:
    ...
    Command-line options:
        ...
        --output, -o    Output EPUB file path (default: <root>/cursor-howto-guide.epub)
...
Output:
    Creates 'cursor-howto-guide.epub' in the repository root directory.
...
Requirements:
    ...
    - Repository structure with markdown files and cursor-howto-logo.png
"""
...
class EPUBConfig:
    ...
    # EPUB Metadata
    identifier: str = "cursor-howto-guide"
    title: str = "Cursor How-To Guide"
    language: str = "en"
    author: str = "EVOVEO INNOVATIONS LIMITED"
...
def validate_inputs(config: EPUBConfig, logger: logging.Logger) -> None:
    ...
    logo_path = config.logo_path or (config.root_path / "cursor-howto-logo.png")
...
def create_cover_image(
    ...
    title: str = "Cursor\nHow-To Guide",
    subtitle: str = "Complete Guide to Cursor Features",
) -> bytes:
...
async def build_epub_async(
    ...
    book.add_metadata("DC", "publisher", "EVOVEO INNOVATIONS LIMITED")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Build an EPUB from Cursor How-To markdown files."
    )
    parser.add_argument(
        "--root",
        "-r",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output EPUB file path (default: <root>/cursor-howto-guide.epub)",
    )
    parser.add_argument(
    ...
    root = root.resolve()
    output = args.output or (root / "cursor-howto-guide.epub")
