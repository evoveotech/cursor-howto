...
![Cursor How To Logo](resources/logos/cursor-howto-logo.svg)

![Icon](resources/icons/cursor-howto-icon.svg)
```
...
| Purpose | Size | File |
|---------|------|------|
| Website header | 520×120 | `logos/cursor-howto-logo.svg` |
| App icon | 256×256 | `icons/cursor-howto-icon.svg` |
...
### Website
- **Header**: Logo (`logos/cursor-howto-logo.svg`)
- **Favicon**: 32px (`favicons/favicon-32.svg`)
- **Social preview**: Icon (`icons/cursor-howto-icon.svg`)

### GitHub
- **README badge**: Icon (`icons/cursor-howto-icon.svg`) at 64-128px
- **Repository avatar**: Icon (`icons/cursor-howto-icon.svg`)

### Social Media
- **Profile picture**: Icon (`icons/cursor-howto-icon.svg`)
- **Banner**: Logo (`logos/cursor-howto-logo.svg`)
