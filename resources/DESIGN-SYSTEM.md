# Cursor How To - Design System

## Visual Identity

### Icon Design Concept: Compass with Code Bracket

The Cursor How To icon uses a **compass with a `>` code bracket** to represent guided navigation through code:
...
- **"Cursor"**: 42px, weight 700 (bold), Black
...
### Web Header
- Size: 520×120px logo
- File: `logos/cursor-howto-logo.svg`
- Background: White or dark (#0A0A0A)
- Padding: 20px minimum

### App Icon
- Size: 256×256px
- File: `icons/cursor-howto-icon.svg`
