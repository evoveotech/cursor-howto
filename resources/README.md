<picture>
  <source media="(prefers-color-scheme: dark)" srcset="logos/cursor-howto-logo-dark.svg">
  <img alt="Cursor How To" src="logos/cursor-howto-logo.svg">
</picture>

# Cursor How To - Brand Assets

Complete collection of logos, icons, and favicons for the Cursor How To project. All assets use the V3.0 design: a compass with code bracket (`>`) symbol, representing guided navigation through code — using a Black/White/Gray palette with Bright Green (#22C55E) accent.
...
resources/
├── logos/
│   ├── cursor-howto-logo.svg       # Main logo - Light mode (520×120px)
│   └── cursor-howto-logo-dark.svg  # Main logo - Dark mode (520×120px)
├── icons/
│   ├── cursor-howto-icon.svg       # App icon - Light mode (256×256px)
│   └── cursor-howto-icon-dark.svg  # App icon - Dark mode (256×256px)
└── favicons/
...
**Files**:
- `logos/cursor-howto-logo.svg` (Light mode)
- `logos/cursor-howto-logo-dark.svg` (Dark mode)
...
**Files**:
- `icons/cursor-howto-icon.svg` (Light mode)
- `icons/cursor-howto-icon-dark.svg` (Dark mode)
...
These assets are part of the Cursor How To project.
...
- **v2.0** (January 2026): Cursor-inspired 12-ray starburst design with emerald palette
