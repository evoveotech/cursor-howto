...
This repository is **built by Evoveo Tech** (**EVOVEO INNOVATIONS LIMITED**) as a visual, example-driven guide to the **Cursor IDE**, **Cursor** in-editor workflows, and the **Cursor CLI** where relevant. We provide:
...
### 3. Feature Guides
Create guides for new Cursor features:
...
- Add relevant Cursor version and OS
