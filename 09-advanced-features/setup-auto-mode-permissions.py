...
Seed ~/.cursor/settings.json with a conservative baseline of safe permissions
for Cursor. The default set is read-only and local-inspection oriented;
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Seed Cursor settings with a conservative permission baseline."
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
