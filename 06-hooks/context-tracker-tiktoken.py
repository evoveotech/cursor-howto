...
def count_tokens(text: str) -> int:
    ...
    This provides ~90-95% accuracy compared to Cursor's actual tokenizer.
    Falls back to character estimation if tiktoken is not available.

    Note: Provider-specific offline tokenizers vary; this uses tiktoken as an approximation.
    tiktoken with p50k_base is a reasonable approximation since both
    Cursor and GPT models use BPE (byte-pair encoding).
    """
